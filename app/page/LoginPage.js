...
export default class LoginPage extends Component {
    ...
    render(){
        return(
            ...
            <ImageButton onPress={this._handleBack.bind(this)} icon="md-arrow-back" color="white" imgSize={px2dp(25)} btnStyle={{width: px2dp(55), height: px2dp(60)}}/>
            </View>
            <View style={styles.logo}>
            <Image style={{width:px2dp(245), height:px2dp(145)}} source={require('../images/ic_login_title.png')}/>
            </View>
